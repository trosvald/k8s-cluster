...
module "oauth2-immich" {
  ...
  launch_url         = "https://photos.${module.secret_authentik.fields["authentik_cluster_domain"]}"
  ...
  redirect_uris = [
    "https://photos.${module.secret_authentik.fields["authentik_cluster_domain"]}/auth/login",
    "app.immich:/"
  ]
}
...
module "oauth2-audiobookshelf" {
  ...
  launch_url         = "https://audiobooks.${module.secret_authentik.fields["authentik_cluster_domain"]}"
  ...
  redirect_uris      = ["https://audiobooks.${module.secret_authentik.fields["authentik_cluster_domain"]}/auth/openid/callback", "audiobookshelf://oauth"]
}
